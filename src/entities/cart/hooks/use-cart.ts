...
export const useCart = () => {
  ...
  const callbacks = {
    ...
    },[addProducts,cartActions,loadProducts,cart]),
    ...
    deleteProductFromCart:useCallback( async (product:IProduct | IProduct[]) => {
      ...
      await callbacks.loadCartProducts({},products)
    },[deleteProducts,cartActions,loadProducts,cart]),
    ...
    },[incrementProduct,cartActions,loadProducts,cart]),
    ...
    },[decrementProduct,cartActions,loadProducts,cart]),
  }
  ...
  return {cart,cartProducts:memoProducts,cartlocalStorageName:localStorageName,isCartProductsLoading:products.isLoading,...callbacks}
}