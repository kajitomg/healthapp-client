...
interface CatalogManagerFilterPriceSelectProps {
...
const CatalogManagerFilterPriceSelect = (props:CatalogManagerFilterPriceSelectProps) => {
...
export {CatalogManagerFilterPriceSelect};